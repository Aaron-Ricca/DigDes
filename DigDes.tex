...
\begin{document}
    \begin{multicols}{3}
        ...
        \input{section/EletricSignal.tex}
        \input{section/SimulazioneVHDL.tex}
        \input{section/Examples.tex}
    \end{multicols}
    \includepdf[pages=-]{section/vhdl_Qualis_Quick_Reference_card.pdf}
\end{document}
